...
//  
// IndicatorType.cs is part of SciChart Examples, a High Performance WPF & Silverlight Chart. 
...
// *************************************************************************************
namespace SciChartElD.Common
{
    public class IndicatorType : StrongTyped<string>
    {
        public IndicatorType(string value) : base(value)
        {
        }

        public static readonly IndicatorType MovingAverage = new IndicatorType("Moving Average");
    }
}